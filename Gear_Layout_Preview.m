clc;clear;
addpath('Gear_system_Designer');
addpath('Gear_system_Designer/gear_param');
addpath('Gear_system_Designer/Geometry_generator/');
addpath('Gear_system_Designer/Gear_train_assembly/');
addpath('data')
load_data('tooth')
...
ad = [10,10,10,tip_diameter(M, Tr)];%軸
