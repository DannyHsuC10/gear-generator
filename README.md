...
## 1. [減速比計算工具(gear_rate)](introduction/Gear_Ratio_Calculation.md)
* 需求:車重、車輪x摩擦、軸距、馬達資料

首先基於車輛加速的重心轉移計算需求扭矩與轉速，並計算齒比。(可搭配 base Analysis 1,2 號工具使用)
## 2. [行星齒輪齒數組合搜尋程式(Number_of_teeth)](introduction/number_of_teeth.md)
* 需求:羊角架構、輪端架構

在討論出hub空間後，我們可以解出整個齒輪系的各個齒輪齒數。(可搭配 base Analysis 3,4,5 號工具使用)3、4步驟僅為輔助，工具成熟度不足時間不構請直接跳至第5步驟使用商用軟體kisssoft。
## 3. [齒輪系布局展示程式(Gear_system_Designer)](introduction/gear_sys.md)
根據算出的齒輪齒數修改csv表格，可以看到所有齒輪長怎樣。看看整個齒輪系的樣子(可搭配 base Analysis 6 號工具使用)
## 4. [齒輪設計介面(Gear_Design_Interface)](introduction/Gear_Design_Interface.md)
...
1. [齒輪慣性](/base_Analysis/introduction/inertia.md) : 快速估算整個齒輪箱的轉動慣量。
